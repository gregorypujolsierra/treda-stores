...
@section('main')
    <div class="row">
        <div class="col-sm-8 offset-sm-2">
            <h1 class="display-3">Add a store</h1>
            <div>
                @if ($errors->any())
                ...
                <form method="post" action="{{ route('stores.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input id="opened_since" type="text" class="form-control @error('opened_since') is-invalid @enderror"
                               name="opened_since" value="{{ old('opened_since') }}" placeholder="dd-mm-yyyy" required autocomplete="opened_since">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary">{{__('Add this store')}}</button>
